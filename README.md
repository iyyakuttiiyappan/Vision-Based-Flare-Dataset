...
SmartFlare is a synchronized multimodal flare-stack dataset collected in a laboratory environment. Each complete sample links RGB imagery, IR imagery, a thermal frame extracted from video, and the nearest gas-analyser record.
